import constants
import numpy as np
from prep_data_2 import prepare_data
from prep_data_2 import device
from prep_data_2 import collate_batch
...
def train(dataloader):
    ...
    for idx, (label, text, offsets) in enumerate(dataloader):
        ...
        loss.backward()
        torch.nn.utils.clip_grad_norm_(model.parameters(), np.float64(0))
        optimizer.step()
